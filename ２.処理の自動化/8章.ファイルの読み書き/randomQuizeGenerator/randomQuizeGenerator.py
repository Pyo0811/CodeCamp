#! python3
# randomQuizGenerator.py ランダム準に問題と答えを問題集と回答集を作る

import random #

# 問題のデータ。キーが都県府庁で、値が県庁所在地
capitals = {'北海道': '札幌市', '青森県': '青森市', '岩手県': '盛岡市',
            ...
            '京都府': '京都市', '大阪府': '大阪市', '兵庫県庫': '神戸市', '奈良県': '奈良市',
            '和歌山県': '和歌山市', '鳥取県': '鳥取市', '鳥根県': '松江市',
            '岡山県': '岡山市', '広島県': '広島市', '山口県': '山口市', '德島県': '德島市',
            '香川県': '高松市', '愛媛県': '松山県', '高知県': '高知市', '福岡県': '福岡市',
...
for quiz_num in range(35): #
    ...
    quiz_file = open('capitalsquiz{}.txt'.format(quiz_num + 1), 'w', encoding='utf8')
    answer_key_file = open('capitalsquiz_answers{}.txt'.format(quiz_num + 1), 'w', encoding='utf8')
